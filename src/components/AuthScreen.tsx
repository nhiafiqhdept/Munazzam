    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 sm:p-6 font-sans">
      ...
      >
        ...
        <button
          ...
          disabled={loading}
          className="w-full py-3 px-4 bg-white border border-slate-200/90 hover:bg-slate-50 hover:border-slate-300 rounded-2xl flex items-center justify-center gap-3 text-slate-700 font-bold text-sm shadow-xs transition-all disabled:opacity-50 disabled:cursor-not-allowed mb-5"
        >
        ...
        <div className="w-full flex items-center gap-3 mb-5">
          ...
          <span className="text-[11px] font-extrabold text-slate-400 uppercase tracking-wider">or continue with email</span>
          <div className="h-px bg-slate-200 flex-1" />
        </div>
